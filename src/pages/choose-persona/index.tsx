...
import { Feather as Icon, Ionicons, AntDesign, MaterialIcons } from '@expo/vector-icons';
            ...
            <View style={styles.content}> 
                <RectButton style={styles.button} onPress={() => handleNavigateToChoosePassword('apreciador')}>
                    <View>
                        ...
                        <Text style={styles.buttonText}>
                            Gosto de cervejas gourmet, sabores diferenciados e novas experiências.
                        </Text>
                    </View>
                </RectButton>
                <RectButton style={styles.button} onPress={() =>handleNavigateToChoosePassword('festeiro')}>
                    <View>
                        ...
                        <Text style={styles.buttonText}>
                            Não ligo muito para cervejas mais caras e quero ver as melhores ofertas.
                        </Text>
                    </View>
                </RectButton>
            </View>
